...
public interface GameListener extends JottoListener {
	 ...
	 * 
	 * @param jotto
	 *            The jotto game whose match has started.
	 * */
	 ...
	 * 
	 * @param jotto
	 *            The jotto game whose match has ended.
	 * */
	 ...
	 * 
	 * @param jotto
	 *            The jotto game where a player has yielded.
	 * */
	 ...
	 * 
	 * @param jotto
	 *            The jotto game in which the player has won.
	 * */
	 ...
	 * 
	 * @param jotto
	 *            The jotto game in which the player has lost.
	 * */
