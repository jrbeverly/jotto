...
import jotto.views.EndDialog;
import jotto.views.Guessboard;
import jotto.views.Letterboard;
...
public class Application extends JFrame implements JottoListener {
    ...
    public Application() {
        ...
        dictionary = new JDictionary(5);
        dictionary.importFrom("words.txt");
                ...
                if (test == JValidation.VALID) {
                    ...
                    switch (test) {
                        ...
                        case PREVIOUSLY_GUESSED:
                            lblMessage.setText("You have already guessed [" + txtGuess.getText() + "].");
                            break;
                        default:
